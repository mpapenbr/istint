...
import { ISettingsState, SettingsActionTypes, StintEditMode, TimeDisplayMode } from "./types";
...
export const updateTimeDisplayMode = (data: TimeDisplayMode): IBaseAction =>
  action(SettingsActionTypes.UPDATE_TIME_DISPLAY_MODE, data);
